...
public class AdminLedger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_ledger);
        ...
        try
        {
            ...
            {
                Toast.makeText(AdminLedger.this, "No Internte", Toast.LENGTH_SHORT).show();
            }
    ...
    private class LoadLedgerCount extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(AdminLedger.this);
        ...
        protected Void doInBackground(String... urls) {
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(new JsonBilder().getHostName() + "selectadminledger.php");
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(AdminLedger.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AdminLedger.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
