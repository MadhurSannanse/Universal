...
public class PartyOutstanding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_outstanding);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        atvparty=(AutoCompleteTextView) findViewById(R.id.atv_partyouts);
        txtamount=(TextView)findViewById(R.id.txt_total);
        lstouts=(ListView)findViewById(R.id.lst_outs);
        try
        {
            ...
            {
                Toast.makeText(PartyOutstanding.this, "No Internte", Toast.LENGTH_SHORT).show();
            }
    ...
    private void loadOutsDetails()
    {
        try
        {
            ...
            for(int i=0;i<outs.size();i++)
            {
                ...
                totalbills[i]="Total Bills : "+data.elementAt(1);
                try {
                    if(onacc==0) {
                ...
                totbil=Double.parseDouble("0"+data.elementAt(1));
                tot=tot+onacc;
                total[i]=""+getResources().getString(R.string.Rs)+" "+roundTwo(Math.abs(tot));
                oid[i]=""+(i+1);
                totalouts=totalouts+tot;
                //Log.e(""+party[i],""+total[i]);
            }

            txtamount.setText(""+getResources().getString(R.string.Rs)+" "+Math.abs(roundTwo(totalouts)));
    ...
    private class LoadOutstandingCount extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(PartyOutstanding.this);
        ...
        protected Void doInBackground(String... urls) {
            try {
                ...
                Log.i("Sals for cnt",""+salesman);
                nameValuePairs.add(new BasicNameValuePair("salesman", ""+salesman));
                try {

                    HttpClient httpclient = new DefaultHttpClient();
                    HttpPost httppost = new HttpPost(new JsonBilder().getHostName() + "selectoutstandingcountsalesman.php");
            ...
            if (Error != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++)
                    {
                        ...
                        arrlst.add(""+jsonObject.getString("party"));
                        outs.addElement(o);
                        Log.e("",""+o.toString());
                    ...
                    Toast.makeText(getApplicationContext(), "No Any Outstanding Available"+e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                }
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(PartyOutstanding.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(PartyOutstanding.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
