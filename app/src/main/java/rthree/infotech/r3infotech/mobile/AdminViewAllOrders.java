...
public class AdminViewAllOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminorderlist=(ListView)findViewById(R.id.lst_adminorderview);
        try
        {
            ...
            if(isNetworkAvailable()) {
                ...
                Toast.makeText(AdminViewAllOrders.this, "No Internte Connection", Toast.LENGTH_SHORT).show();
            }
            adminorderlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(AdminViewAllOrders.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AdminViewAllOrders.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
    ...
    private class LoadOrders extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(AdminViewAllOrders.this);
        ...
        protected Void doInBackground(String... urls) {
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(new JsonBilder().getHostName() + "selectcountallorder.php");
