...
public class AdminCashReceipt extends AppCompatActivity {
    ...
    private class LoadPartyNames extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(AdminCashReceipt.this);
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(AdminCashReceipt.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AdminCashReceipt.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
    ...
    public void loadRefrenceNumber()
    {
        try
        {
            AlertDialog.Builder  builderSingle = new AlertDialog.Builder(AdminCashReceipt.this);
            builderSingle.setIcon(R.drawable.ic_reclist);
            builderSingle.setTitle("Select As Refrences ");

            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AdminCashReceipt.this, android.R.layout.simple_list_item_multiple_choice);
            ...
            builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    AlertDialog.Builder builderInner = new AlertDialog.Builder(AdminCashReceipt.this);
