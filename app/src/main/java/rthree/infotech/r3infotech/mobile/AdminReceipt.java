...
public class AdminReceipt extends AppCompatActivity {
    private static final int REQUEST_READ_PHONE_STATE = 1;
    Button btn_process;
    private static final int INTERNET=1;
    AutoCompleteTextView party;
    String usertype,username,locationstr,customername,finalamount;
    Vector customer,refrences,addredref;
    EditText txt_amount,txt_refrence,txt_recnumber;
    Vector receipt;
    ...
    double refamount=0;
    int receiptNumber=1;
    String refreceforpdf="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_receipt);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        txt_amount=(EditText)findViewById(R.id.et_amount);
        txt_refrence=(EditText)findViewById(R.id.et_reference);
        ...
        txt_recnumber=(EditText)findViewById(R.id.et_adminrecnumber);
        customername="";
        ...
        try
        {
            ...
            finalamount=b.getString("Amount");
            receipt=new Vector();
                    ...
                    try {
                        ...
                        if (party.getText().toString().trim().equals("Select Party")) {
                            ...
                            if (valid) {
                                ...
                                String chnumber = txt_refrence.getText().toString().trim();
                                ...
                                receipt.addElement("" + ""+chnumber);
                                receipt.addElement("" + locationstr);
                                receipt.addElement("" + username);
                                receipt.addElement("" + paymenttype.getSelectedItem().toString());
                                ...
                                Log.e("Receipt Details", "" + receipt.toString());
                                if (isNetworkAvailable()) {
                                    refreceforpdf=""+txt_refrence.getText();
    ...
    private class LoadPartyNames extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(AdminReceipt.this);
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(AdminReceipt.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AdminReceipt.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
    ...
    public void loadPaymentType()
    {
        try
        {
            ...
            arrayList.add("PayTM");
            arrayList.add("Rezorpay");
            arrayList.add("Others");
            ArrayAdapter ard = new ArrayAdapter(this, R.layout.spinneritems, arrayList);
            ard.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            paymenttype.setAdapter(ard);
        }
        catch (Exception ex){}
    }
    ...
    public void loadRefrenceNumber()
    {
        try
        {
            AlertDialog.Builder  builderSingle = new AlertDialog.Builder(AdminReceipt.this);
            builderSingle.setIcon(R.drawable.ic_reclist);
            builderSingle.setTitle("Select As Refrences ");

            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AdminReceipt.this, android.R.layout.simple_list_item_multiple_choice);
            ...
            builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    AlertDialog.Builder builderInner = new AlertDialog.Builder(AdminReceipt.this);
        ...
        protected void onPostExecute(Void unused) {
            ...
            if (Error != null) {
                ...
                try {
                    ...
                    try{receiptNumber=1;
                     txt_recnumber.setText(""+receiptNumber);
                    }catch (Exception ex){Log.e("Receipt No",""+e.getMessage());}
