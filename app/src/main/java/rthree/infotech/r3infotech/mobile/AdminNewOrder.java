...
public class AdminNewOrder extends AppCompatActivity {
                        ...
                        else if(date.getText().toString().trim().equals(""))
                        {
                            ...
                            if(valid) {
                                ...
                                if(!issuspended) {
                                    ...
                                    i.putExtra("Plevel", "" + plev);
                                    // Log.e("Price Level",""+plev);
                                    //  finish();
                                    startActivity(i);
                                }
                                else
    ...
    private class LoadPartyNames extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(AdminNewOrder.this);
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(AdminNewOrder.this, Manifest.permission.INTERNET);
