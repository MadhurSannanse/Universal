...
public class TeamLederReceiptView extends AppCompatActivity {
    String [] sname,total,totalorder,oid;
    String usertype,username;
    private static final int REQUEST_READ_PHONE_STATE =1 ;
    private static final int INTERNET=1;
    ListView teamledreceiptlist;
    Vector receipt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_leder_receipt_view);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        teamledreceiptlist=(ListView)findViewById(R.id.lst_teamledorderview);
        try {
            ...
            if (isNetworkAvailable()) {
                ...
                Toast.makeText(TeamLederReceiptView.this, "No Internte Connection", Toast.LENGTH_SHORT).show();
            }
            teamledreceiptlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    if (isNetworkAvailable()) {
                        ...
                        Toast.makeText(TeamLederReceiptView.this, "No Internte", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(TeamLederReceiptView.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(TeamLederReceiptView.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
    ...
    private void loadOrderDetails()
    {
        try
        {
            ...
            teamledreceiptlist.setAdapter(adapter);
        }
        catch(Exception ex)
        {
    ...
    private class LoadReceipts extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(TeamLederReceiptView.this);
        ...
        protected Void doInBackground(String... urls) {
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(new JsonBilder().getHostName() + "selectcountteamreceipt.php");
