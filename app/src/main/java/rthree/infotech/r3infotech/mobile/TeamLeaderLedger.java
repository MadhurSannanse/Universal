...
public class TeamLeaderLedger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_leader_ledger);
        ...
        try
        {
            ...
            {
                Toast.makeText(TeamLeaderLedger.this, "No Internte", Toast.LENGTH_SHORT).show();
            }
        ...
        try
        {
            ...
            for(int i=0;i<ledger.size();i++)
            {
               ...
               /* try {
                ...
                if(tot<0)
                {
                    total[i]="Dr  "+getResources().getString(R.string.Rs)+" "+Math.abs(tot);
                }
                else
                {
                    total[i]="Cr  "+getResources().getString(R.string.Rs)+" "+tot;
                }*/
                total[i]="";
                oid[i]=""+(i+1);
    ...
    private class LoadLedgerCount extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(TeamLeaderLedger.this);
        ...
        protected Void doInBackground(String... urls) {
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(new JsonBilder().getHostName() + "selectteamleaderledger.php");
            ...
            if (Error != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++)
                    {
                        ...
                        o.addElement(jsonObject.getString("cnt"));
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(TeamLeaderLedger.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(TeamLeaderLedger.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
