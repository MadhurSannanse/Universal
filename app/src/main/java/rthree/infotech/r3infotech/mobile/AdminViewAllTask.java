...
public class AdminViewAllTask extends AppCompatActivity {
    String [] sname,total,totalorder,oid;
    String usertype,username;
    private static final int REQUEST_READ_PHONE_STATE =1 ;
    private static final int INTERNET=1;
    ListView admintasklist;

    Vector task;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_view_all_task);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        admintasklist=(ListView)findViewById(R.id.lst_admintaskview);
        try
        {
            ...
            if(isNetworkAvailable()) {
                ...
                Toast.makeText(AdminViewAllTask.this, "No Internte Connection", Toast.LENGTH_SHORT).show();
            }
            admintasklist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(AdminViewAllTask.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AdminViewAllTask.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
    ...
    private class LoadTask extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(AdminViewAllTask.this);
        ...
        protected void onPreExecute() {
            ...
            Dialog.setMessage("Please Wait Task Is Loading");
            Dialog.show();
        }
        ...
        protected Void doInBackground(String... urls) {
            try {
                ...
                try {
                    ...
                    HttpPost httppost = new HttpPost(new JsonBilder().getHostName() + "selecttaskcount.php");
