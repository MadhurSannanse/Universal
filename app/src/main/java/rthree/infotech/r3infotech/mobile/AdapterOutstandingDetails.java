 ...
 */
public class AdapterOutstandingDetails extends ArrayAdapter<String> {
    String[] name = {};
    String[] total={};
    String[] totalbills={};
    String []oid={};
    ...
    public AdapterOutstandingDetails(Context context, String[] name, String[] totalbills, String[] total, String[] oid) {
        ...
        this.oid=oid;
        outstanding=new OutstandingDetails();
