...
public class Receipt extends AppCompatActivity {
    ...
    private class LoadPartyNames extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Receipt.this);
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(Receipt.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Receipt.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
    ...
    public void loadRefrenceNumber()
    {
        try
        {
            AlertDialog.Builder  builderSingle = new AlertDialog.Builder(Receipt.this);
            builderSingle.setIcon(R.drawable.ic_reclist);
            builderSingle.setTitle("Select As Refrences ");

            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Receipt.this, android.R.layout.simple_list_item_multiple_choice);
            ...
            builderSingle.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    AlertDialog.Builder builderInner = new AlertDialog.Builder(Receipt.this);
