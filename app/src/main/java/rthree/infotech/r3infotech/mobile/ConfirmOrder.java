...
public class ConfirmOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        catch (Exception ex){Log.e("Content Error",""+ex.getMessage());}
    ...
    private class LoadOrder extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(ConfirmOrder.this);
    ...
    private boolean isNetworkAvailable() {
        int permissionCheck = ContextCompat.checkSelfPermission(ConfirmOrder.this, Manifest.permission.INTERNET);

        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ConfirmOrder.this, new String[]{Manifest.permission.INTERNET}, INTERNET);
...
// draw text on the graphics object of the page
    ...
    public void createPDFInvoice(String str)
    {
        ...
        try {
            int permissionCheck = ContextCompat.checkSelfPermission(ConfirmOrder.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
            if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
